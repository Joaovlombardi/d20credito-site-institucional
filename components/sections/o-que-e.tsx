...
const modalidades = [
  { icon: House, name: "Home equity", garantia: "O imóvel" },
  { icon: Car, name: "Car equity", garantia: "O veículo" },
  {
    icon: Gavel,
    name: "Legal Equity",
...
/**
 * Teaser na Home: apresenta a analogia e empurra para /legal-equity, que é
 * quem detalha cada modalidade.
 */
  ...
  return (
    <Section tone="surface" id="legal-equity">
      ...
      <ul className="mt-14 grid gap-6 md:grid-cols-3">
        {modalidades.map(({ icon: Icon, name, garantia, destaque }) => (
          <li
            key={name}
          ...
          >
            ...
            <div>
              <p
                className={`text-sm font-bold ${destaque ? "text-white/70" : "text-muted"}`}
              >
                {name}
              </p>
      ...
      <div className="mt-12 text-center">
        <Button href="/legal-equity" variant="primary">
